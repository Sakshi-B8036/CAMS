...
// ---------------------------------------- 
// 2. Fetch Class List (All students for now) 
// Note: For simplicity, we fetch ALL students. A more advanced system would link students to classes/streams. 
// For now, we assume all students can be marked for attendance. 
// ---------------------------------------- 
$students = []; 
$subject_name = ""; 
$error = ""; 
...
// Fetch list of students (S201 is the test student) 
